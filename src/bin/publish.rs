...
<div class="container">
    <header>
        ...
        <div class="bio">founding eng/research <a href="https://x.com/tplus_cx">@tplus_cx</a>, ex co-founder (now advisor) <a href="https://x.com/xyclooLabs">@xyclooLabs</a>, trusted (?) execution</div>
    </header>
